 ...
 */
class FlippedCategoryCoordinateCalculator extends CoordinateCalculatorBase_1.CoordinateCalculatorBase {
    /**
    ...
    constructor(webAssemblyContext, viewportDimension, visibleMin, visibleMax, indexMin, indexMax, offset = 0) {
        super(webAssemblyContext, viewportDimension, visibleMin, visibleMax, offset, false, true);
        this.indexMin = indexMin;
        this.indexMax = indexMax;
        this.nativeCalculator = new webAssemblyContext.FlippedCategoryCoordinateCalculatorDouble(this.viewportDimension, this.visibleMin, this.visibleMax, -1, this.offset, this.indexMin, this.indexMax);
    }
    /**
